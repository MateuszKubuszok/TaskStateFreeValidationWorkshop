...
import workshop.free.ScalazCalculation.Ops
...
class ScalazCalculationIdInterpreterSpec extends Specification with ScalazInterpreterTestParams {

  "ScalazCalculationIdInterpreter" should {
  ...
  trait Fixture extends Scope {
    ...
    val interpreter = new ScalazCalculationIdInterpreter(

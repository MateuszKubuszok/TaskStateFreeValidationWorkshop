...
import workshop.free.ScalazCommand.Ops
import org.specs2.mutable.Specification
import org.specs2.specification.Scope

import scala.collection.mutable

class ScalazCommandIdInterpreterSpec extends Specification with ScalazInterpreterTestParams {
  ...
  trait Fixture extends Scope {
    ...
    val interpreter = new ScalazCommandIdInterpreter(
